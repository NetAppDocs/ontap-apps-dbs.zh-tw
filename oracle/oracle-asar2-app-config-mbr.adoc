...
summary: Oracle 資料庫參數 - db_file_multiblock_read_count（ ASA r2） 
searchtitle: Oracle 資料庫參數 - db_file_multiblock_read_count（ ASA r2） 
---
...
與AFF/ FAS系統相比，建議沒有變化。ONTAP 的行為和 Oracle 最佳實務在ASA r2、 AFF和FAS平台上保持不變。
