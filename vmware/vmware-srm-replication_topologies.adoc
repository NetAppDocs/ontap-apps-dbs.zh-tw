...
有關ONTAP 9 的SnapMirror和SnapVault的最新信息，請參閱 https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["TR-4015《SnapMirror組態最佳實務指南ONTAP 》（英文）。"^]
