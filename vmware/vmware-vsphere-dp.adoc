...
有關快照的更多信息，請參閱ONTAP文件。以下連結提供了更多詳細資訊： https://docs.netapp.com/us-en/ontap/data-protection/manage-local-snapshot-copies-concept.html["ONTAP 本機快照複本"^] https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-replication-workflow-concept.html["ONTAP SnapMirror複製工作流程"^]
