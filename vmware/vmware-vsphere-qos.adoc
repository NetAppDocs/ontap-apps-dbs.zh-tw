...
NOTE: vVols 需要使用 ONTAP tools for VMware vSphere，該工具可作為 ONTAP 的 VASA Provider。請參閱 link:vmware-vvols-overview.html["VMware vSphere 虛擬磁碟區（ VVols ）搭配 ONTAP"] 以瞭解 vVols 最佳實務。
