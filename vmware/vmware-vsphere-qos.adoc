...
* 附註： * vVols 需要使用 ONTAP 工具來執行 VMware vSphere 、以作為 VASA Provider for ONTAP 。請參閱 link:/vmware/vmware-vvols-overview.html["VMware vSphere 虛擬磁碟區（ VVols ）搭配 ONTAP"] 適用於 VVols 最佳實務做法。
